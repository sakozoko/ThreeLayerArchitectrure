    ...
    public class OrderServiceTest
    {
        ...
        public void GetAllTestCorrectlyWork()
        {
            var expectedOrders = new List<OrderEntity>
            {
                ...
                new OrderEntity() { Id = 4 },
                new OrderEntity() { Id = 5 },
                new OrderEntity() { Id = 6 }
            };
        ...
        public void GetUserOrdersCorrectlyWork()
        {
            ...
            {
                new OrderEntity() { Id = 1, Owner = owner },
                new OrderEntity() { Id = 2, Owner = owner },
                new OrderEntity() { Id = 3, Owner = owner },
                new OrderEntity() { Id = 4, Owner = new UserEntity { Id = 2 } },
                new OrderEntity() { Id = 5, Owner = owner },
                new OrderEntity() { Id = 6, Owner = owner }
            };
            var moqLogger = new Mock<ILogger>();
            moqLogger.Setup(x => x.Log(It.IsAny<string>())).Verifiable();
            var tokenHandler = Mock.Of<ITokenHandler>(x => x.GetUser(It.IsAny<string>()) == owner);
        ...
        {
            MethodsTestReturnedExceptionIfUserIsNotAdmin(service =>
                service.OrderService.ChangeOrderStatus("", status, 1));
        }
        ...
        {
            MethodsTestReturnedExceptionIfUserIsNull(service =>
                service.OrderService.ChangeDescription("", "New value", 1));
        }
        ...
        {
            MethodsTestReturnedExceptionIfUserIsNotAdmin(service =>
                service.OrderService.ChangeDescription("", "Value", 1));
        }
